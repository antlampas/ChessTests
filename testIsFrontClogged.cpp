...
TEST_CASE("Is Front Clogged?", "[isfrontclogged]")
{
    ...
    CHECK(b.isFrontClogged("c2"));
    CHECK(b.isFrontClogged("h7"));
    CHECK(b.isFrontClogged("c5"));
    CHECK_FALSE(b.isFrontClogged("a1"));
    CHECK_FALSE(b.isFrontClogged("c3"));
    CHECK_FALSE(b.isFrontClogged("e5"));
}